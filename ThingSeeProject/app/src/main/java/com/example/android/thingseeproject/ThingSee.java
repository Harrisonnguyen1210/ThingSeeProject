...
public class ThingSee {
                ...
                for (int j = 0; j < senses.length(); j++) {
                    ...
                    switch (senseID) {
                        case GROUP_ENVIRONMENT | PROPERTY1:
                            sensorValue.setTemp(value);
                            break;
                        case GROUP_ENVIRONMENT | PROPERTY2:
                            sensorValue.setHum(value);
                            break;
                        case GROUP_ENVIRONMENT | PROPERTY3:
                            sensorValue.setLux(value);
                            break;
                        case GROUP_ACCELERATION | PROPERTY4:
                            sensorValue.setImpact(value);
                            break;
                        case GROUP_ENERGY | PROPERTY2:
                            sensorValue.setEnergy(value);
                            break;
                        case GROUP_SPEED | PROPERTY1:
                            sensorValue.setSpeed(value);
                            break;
                    }
                    ...
                    switch (senseID) {
                        case GROUP_LOCATION | PROPERTY1:
                            ...
                            sensorValue.setLatitude(value);
                            k++;
                            break;

                        case GROUP_LOCATION | PROPERTY2:
                            loc.setLongitude(value);
                            sensorValue.setLongitude(value);
                            k++;
                            break;
                    }
    ...
    public SensorValue returnSensorValue() {
        return sensorValue;
    }
