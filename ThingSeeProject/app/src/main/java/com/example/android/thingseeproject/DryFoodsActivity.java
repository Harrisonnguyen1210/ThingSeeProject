...
public class DryFoodsActivity extends AppCompatActivity {

    TextView txtHum, txtEnergy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dry_foods);
        ...
        txtHum = (TextView) findViewById(R.id.putTemp);
        txtEnergy.setText("" + sensorValue.getEnergy()+"%");
        txtHum.setText("" + sensorValue.getHum());
    }

    public void LocationButton(View v) {
        Intent intent = new Intent(DryFoodsActivity.this, MapsActivity.class);
